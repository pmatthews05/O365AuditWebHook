...
Write-Information "Stopping Subscription $ContentType" 
Invoke-WebRequest -Method Post -Body:$body -ContentType "application/json" -Headers $headerParams -Uri "https://manage.office.com/api/v1.0/$TenantGUID/activity/feed/subscriptions/stop?contentType=$contentType"